          ...
          <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-5 lg:p-10 text-gray-800 relative md:flex items-center text-center md:text-left">
              <div className="w-full md:w-1/2">
                  ...
                  <div className=" text-gray-600 font-light">
                      <h2 className="text-primary mb-4 text-3xl font-bold">{status || 404}</h2>
                  ...
                  <div className="mb-20 md:mb-0">
                      <Link to='/' className='my-btn flex items-center'>
                        <FaArrowLeft className="mr-1"></FaArrowLeft> Go Back to homepage
                      </Link>
                  </div>
              </div>
              <div className="w-full md:w-1/2 text-center">
                  <a href="https://raw.githubusercontent.com/Rukshanarupu/assignment-image-link/main/Assignment-11-img/404-error.avif" target="_blank" rel="noreferrer" className="text-xs text-gray-300"> page created by Rupu</a>
              </div>
          </div>
